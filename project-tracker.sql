...
--
-- Name: grades; Type: TABLE; Schema: public; Owner: abdelalieljaouhari
--
...
ALTER TABLE public.grades OWNER TO abdelalieljaouhari;

--
-- Name: grades_id_seq; Type: SEQUENCE; Schema: public; Owner: abdelalieljaouhari
--
...
ALTER TABLE public.grades_id_seq OWNER TO abdelalieljaouhari;

--
-- Name: grades_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Name: grades id; Type: DEFAULT; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Data for Name: grades; Type: TABLE DATA; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Name: grades_id_seq; Type: SEQUENCE SET; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Name: grades grades_pkey; Type: CONSTRAINT; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Name: grades grades_project_title_fkey; Type: FK CONSTRAINT; Schema: public; Owner: abdelalieljaouhari
--
...
--
-- Name: grades grades_student_github_fkey; Type: FK CONSTRAINT; Schema: public; Owner: abdelalieljaouhari
--
